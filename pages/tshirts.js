        ...
        <div className="flex flex-wrap -m-4">
         ...
         return <Link passHref={true} key={products[item]._id} href={`/product/${products[item].slug}`}><div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-2 ">
            ...
            <div className="mt-4 text-center md:text-left">
              ...
              {products[item].color.includes('Sea Green')&&<button className="border-2 border-gray-300 bg-teal-300 rounded-full w-6 h-6 focus:outline-none"></button>}
              ...
              {products[item].color.includes('Purple')&&<button className="border-2 border-gray-300 bg-purple-500 rounded-full w-6 h-6 focus:outline-none"></button>}
